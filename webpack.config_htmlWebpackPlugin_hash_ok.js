...
var config = {
  ...
  /**
   * cho webpack-dev-serve chỉ open port ở localhost
   * Cái này tự động build khi có thay đổi và update server code, tuy nhiên ko tự refresh page như LiveServer (vì ko có clientLiveServer)
   */
  devServer: {
    open: true,
    host: 'localhost'
